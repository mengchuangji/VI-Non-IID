...
# parser.add_argument('--train_data_num', default=100000, type=int, help='the num of the train_data')
parser.add_argument('--aug_times', default=8, type=int, help='Number of aug operations')
...
save_dir = os.path.join('models_denoise', args.model+'_' + 'sigma' + str(sigma)+'_aug')
...
if __name__ == '__main__':
    ...
    xs = datagenerator(data_dir = args.data_dir,patch_size = args.patch_size,stride = args.stride,train_data_num = args.train_data_num,
        download=args.download,datasets =args.datasets,aug_times=args.aug_times,scales = args.scales,verbose=args.verbose,jump=args.jump,agc=False)
    # x_tar = datagenerator_tar(data_dir='/home/mcj/mcj/code/VDN_mcj/data/fielddata/train/clean',
    #                                       patch_size=(40, 40), stride=(32, 32),
    ...
    # xs = np.concatenate((xs, x_tar), axis=0)
