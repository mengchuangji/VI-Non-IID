...
def main():
    ...
    train_im_list = generate_patch_from_mat(dir="/home/shendi_mcj/datasets/seismic/marmousi", pch_size=64, stride=[64, 64])
    ...
    test_im_list = generate_patch_from_mat(dir="/home/shendi_mcj/datasets/seismic/overthrust", pch_size=128,
                                           stride=[24, 64])
