...
def main():
    ...
    args.milestones = [10, 20, 25, 30, 35, 40, 45, 50,60]
    ...
    datasets = {'train':DenoisingDatasets_seismic.BenchmarkTrain(path_SIDD_train, 50 * args.batch_size,
